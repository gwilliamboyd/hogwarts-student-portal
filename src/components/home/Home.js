			...
			<div className='home-master'>
				<div className='home-container'>
					<PageContainer
						...
						paragraph={
							<>
								Bio info on over <b>400</b> characters from the wizarding world!
								<br />
					...
					<PageContainer
						...
						paragraph={
							<>
								Find out which characters you'll be rooming with this year!
								<br />
					...
					<PageContainer
						...
						paragraph={
							<>
								Comprehensive spell reference for all subjects!
								<br />
								<i>
									(Just don’t let Professor McGonagall catch you using this
									during class...)
								</i>
							</>
						}
